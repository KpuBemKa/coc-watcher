...
from human_cursor.utilities.human_curve_generator import HumanizeMouseTrajectory
from human_cursor.utilities.calculate_and_randomize import generate_random_curve_parameters
...
class SystemCursor:
    ...
    def move_to(point: list or tuple, duration: int or float = None, human_curve=None, steady=False):
        ...
        pause_duration = duration / len(human_curve.points)
